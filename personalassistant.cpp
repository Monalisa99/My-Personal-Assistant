#include <bits/stdc++.h>
	...
	void greetings(){
	    ...
	    if (time-> tm_hour < 12){
	        cout<< "Hello Get ready for the classes"<<endl;
	        string phrase = "Hello Get ready for the classes";
	        ...
	        cout<< "Now it is lunch time"<<endl;
	        string phrase = "Now it is lunch time";
	        string command = "espeak \"" + phrase + "\"";
	        const char *charCommand = command.c_str();
	        system(charCommand);
	    }
	        ...
	        cout<< "Exercise time "<<endl;
	        string phrase = "Exercise time";
	        string command = "espeak \"" + phrase + "\"";
	        const char *charCommand = command.c_str();
	        system(charCommand);
	    }
	    ...
	    do
	    {
	        ...
	        if(password=="guddy")
	        {
	            ...
	            do{
	                ...
	                string phrase = "How can i help you Mona";
	                string command = "espeak \"" + phrase + "\"";
	                const char *charCommand = command.c_str();
	                system(charCommand);
	                ...
	                {
	                    cout<<"Hello Mona Welcome"<<endl;
	                    string phrase = "Hello Mona welcome";
	                    string command = "espeak \"" + phrase + "\"";
	                    const char *charCommand = command.c_str();
	                    system(charCommand);
	                }
	                ...
	                {
	                    cout<<"I'm your personal assistant "<<endl;
	                    string phrase = "I'm your personal assistant ";
	                    string command = "espeak \"" + phrase + "\"";
	                    const char *charCommand = command.c_str();
	                    system(charCommand);
	                }
	                ...
	                else if(command=="bye" || command=="exit")
	                {
	                    ...
	                    string phrase = "Good Bye Mona, see you soon!";
	                    string command = "espeak \"" + phrase + "\"";
	                    const char *charCommand = command.c_str();
	                    system(charCommand);
	                    exit(0);
